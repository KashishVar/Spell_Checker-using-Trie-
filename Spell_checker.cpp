//Spell check using Trie ... If the word is present it will print the word otherwise it will give the suggestions for the particular word ...
//additionally we can delete a particular word from Trie , also we can update the word in Trie .
#include<bits/stdc++.h> 
using namespace std; 
